...
export default function MoveCard(props: MoveCardProps): ReactNode {
    ...
    return (
        <div className="flex flex-col items-center gap-2 w-115 pr-1 py-1 my-1 bg-gray-700 rounded-2xl">
            <div className="flex flex-col gap-2">
                <div
                    className={`flex w-113 h-full justify-between items-center gap-2 p-1 rounded-2xl border-1 border-white/50 ${getTypeColorClass(
                ...
                >
                    ...
                    <span>{props.moveData.move.getDisplayFlags()}</span>
                </div>
                <span>
                    {` ${props.moveData.move.getPower(
                        props.user,
                        props.target,
                        props.battleState,
